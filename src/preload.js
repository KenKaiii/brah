...
contextBridge.exposeInMainWorld("brah", {
  ...
  getSoulNotes: () => ipcRenderer.invoke("memory:list-soul"),
  deleteSoulNotes: (ids) => ipcRenderer.invoke("memory:delete-soul", ids),
  updateMemoryEntry: (kind, id, content) => ipcRenderer.invoke("memory:update", kind, id, content),
  extractMemory: (transcript) => ipcRenderer.invoke("memory:extract", transcript),
  noteUserTurn: () => ipcRenderer.invoke("call:user-turn"),
